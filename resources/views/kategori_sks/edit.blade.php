        ...
        <div class="max-w-3xl mx-auto">
            <div class="flex items-center gap-3 mb-6">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-500">Perbarui informasi kategori surat keputusan.</p>
                </div>
            </div>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                ...
                <div class="p-6 md:p-8">
                    <form action="{{ route('kategori-sks.update', $kategori->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="space-y-6">
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text" name="jenis_surat" value="{{ old('jenis_surat', $kategori->jenis_surat) }}"
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text" name="kode_klasifikasi" value="{{ old('kode_klasifikasi', $kategori->kode_klasifikasi) }}"
